...
class RepositoryImpl extends Repository {
  ...
  Future<Either<Failure, RemoteConfigModel>> login(
    ...
    try {
      final response =
          await swagger!.loginGet(deviceId: model.deviceId, token: model.token);
  ...
  @override
  Future<Either<Failure, sw.Event>> getEventByGuid(String guid) async {
    try {
      final response = await swagger!.eventGuidGet(guid: guid);
